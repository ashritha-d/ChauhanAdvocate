...
const defaultServices = [
  ...
  { title: 'Family Law', icon: 'fas fa-users', shortDescription: 'Sensitive and effective family legal matters.', description: 'Comprehensive family law services covering divorce, custody, maintenance, matrimonial matters, and RCR petitions.', features: ['Divorce Proceedings', 'Child Custody', 'Maintenance', 'Domestic Violence', 'Marriage Registration', 'RCR (Restitution of Conjugal Rights)'], order: 3, isActive: true, isFeatured: true },
  ...
  { title: 'Property Law', icon: 'fas fa-home', shortDescription: 'Expert property and real estate legal services, including legal opinions and documentation.', description: 'Comprehensive property law services including title verification, transactions, disputes, and expert legal opinions on property matters.', features: ['Title Verification', 'Sale/Purchase Deeds', 'Property Disputes', 'RERA Matters', 'Tenant Issues', 'Legal Opinions on Property Matters'], order: 5, isActive: true, isFeatured: false },
