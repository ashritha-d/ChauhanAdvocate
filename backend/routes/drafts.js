...
router.post('/',             protect, upload.fields([{ name: 'thumbnail', maxCount: 1 }, { name: 'draftFile', maxCount: 1 }]), ctrl.create);
router.put('/:id/publish',   protect, ctrl.publish);
router.put('/:id',           protect, upload.fields([{ name: 'thumbnail', maxCount: 1 }, { name: 'draftFile', maxCount: 1 }]), ctrl.update);
