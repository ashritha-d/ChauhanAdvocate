...
function JrAdvocateModal({ onClose }) {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (r.data.success) { setSubmitted(true); }
      else setSubmitError(r.data.message || 'Submission failed');
    } catch (err) {
              ...
              {step === 1 && (
                <div className="row g-2">
                  ...
                  <div className="col-md-3">
                    ...
                    <input className="form-control form-control-sm" value={form.percentage} onChange={set('percentage')} placeholder="e.g., 75% / 8.2" />
                  </div>
                  <div className="col-12">
                  ...
                  <div className="col-12">
                    ...
                    <textarea className="form-control form-control-sm" rows={3} value={form.coverLetter} onChange={set('coverLetter')} placeholder="Why do you want to join us? Any additional information..." />
                  </div>
                </div>
              )}
              ...
              {step === 2 && (
                <div className="row g-3">
                  ...
                  <div className="col-12">
                    ...
                    <div
                      className={`jr-upload-zone ${passportPhoto ? 'has-file' : ''}`}
                  ...
                  <div className="col-12">
                    <div className="alert alert-info py-2 small">
                      ...
                      By submitting, you confirm that all details provided are accurate. We will contact you within 3–5 business days.
                    </div>
                  </div>
                </div>
              )}
